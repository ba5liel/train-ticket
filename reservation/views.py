...
def daily_schedule(request):
    daily_trains = trains.objects.filter(schedule_type='Daily')
    return render(request, 'daily_schedule.html', {'trains': daily_trains})
def weekly_schedule(request):
    weekly_trains = trains.objects.filter(schedule_type='Weekly')
    return render(request, 'weekly_schedule.html', {'trains': weekly_trains})
